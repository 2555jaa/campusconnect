      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-3xl sm:text-4xl lg:text-5xl font-bold text-navy-500 dark:text-white mb-8 leading-tight"
          >
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 leading-relaxed mb-12"
          >
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-left">
            <motion.div
              ...
              className="p-6 rounded-2xl bg-gray-50 dark:bg-slate-800/50 border border-gray-100 dark:border-slate-800"
            >
              <div className="w-10 h-10 rounded-xl bg-primary-100 text-primary-600 flex items-center justify-center mb-4">
                <Target className="w-5 h-5" />
              </div>
              <h3 className="font-bold text-navy-500 dark:text-white mb-2">Purpose-Driven</h3>
            ...
            >
              ...
              <h3 className="font-bold text-navy-500 dark:text-white mb-2">Student First</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
            ...
            >
              ...
              <h3 className="font-bold text-navy-500 dark:text-white mb-2">Community Oriented</h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 leading-relaxed">
